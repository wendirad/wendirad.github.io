...
export default function InfoSection() {
  ...
  return (
    <section className="min-h-screen min-w-full flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          <div className="flex-1 order-2 lg:order-1 text-center lg:text-left">
            ...
            <div className="flex flex-col items-center lg:items-start gap-6">
              ...
              <div className="flex items-center justify-center lg:justify-start gap-6">
                <a href={info.github} target="_blank" rel="noopener noreferrer" className="text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 transition-colors">
                ...
                <a href={info.linkedin} target="_blank" rel="noopener noreferrer" className="text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="order-1 lg:order-2 flex-shrink-0">
            <img 
              ...
              alt={info.name}
              className="w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 rounded-lg object-contain"
            />
          </div>
        </div>
      </div>
